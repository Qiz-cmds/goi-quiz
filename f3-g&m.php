   ...
   <?php
     if (isset($_SESSION['button_clicked'])) {
      switch ($_SESSION['button_clicked']) {
          case '11':
              $image='image/chap11-2.jpg';
              $buttonText='ARE YOU READY?';
              $buttonLink="guessf3-ch1.html";
              $buttonStyle='font-size:28px; border-radius : 20px';

              break;
          case '12':
            $image='image/chap12.jpg';
            $buttonText='ARE YOU READY?';
            $buttonLink="guessf3-ch2.html";
            $buttonStyle='font-size:28px; border-radius : 20px';

              break;
          case '13':
            $image='image/chap13.jpg';
            $buttonText='ARE YOU READY?';
            $buttonLink="guessf3-ch3.html";
            $buttonStyle='font-size:28px; border-radius : 20px';

              break;
              case '14':
                $image='image/chap14.jpg';
                $buttonText='ARE YOU READY?';
                $buttonLink="guessf3-ch4.html";
                $buttonStyle='font-size:28px; border-radius : 20px';

                  break;
                  case '15':
                    $image='image/chap15.jpg';
                    $buttonText='ARE YOU READY?';
                    $buttonLink="guessf3-ch5.html";
                    $buttonStyle="font-size:28px; border-radius : 20px";
