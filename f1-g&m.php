   ...
   <?php
     if (isset($_SESSION['button_clicked'])) {
      switch ($_SESSION['button_clicked']) {
          case '1':
              $image='image/chap1.jpg';
              $buttonText='ARE YOU READY?';
              $buttonLink="guessf1-ch1.html";
              $buttonStyle='font-size:28px; border-radius : 20px';

              break;
          case '2':
            $image='image/chap2.jpg';
            $buttonText='ARE YOU READY?';
            $buttonLink="guessf1-ch2.html";
            $buttonStyle='font-size:28px; border-radius : 20px';

              break;
          case '3':
            $image='image/chap31.jpg';
            $buttonText='ARE YOU READY?';
            $buttonLink="guessf1-ch3.html";
            $buttonStyle='font-size:28px; border-radius : 20px';

              break;
              case '4':
                $image='image/chap4-2.jpg';
                $buttonText='ARE YOU READY?';
                $buttonLink="guessf1-ch4.html";
                $buttonStyle='font-size:28px; border-radius : 20px';

                  break;
                  case '5':
                    $image='image/chap5.jpg';
                    $buttonText='ARE YOU READY?';
                    $buttonLink="guessf1-ch5.html";
                    $buttonStyle="font-size:28px; border-radius : 20px";
